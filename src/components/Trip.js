...
import Trip1 from "../assest/img-9.jpg";
import Trip2 from "../assest/img-10.jpg";
import Trip3 from "../assest/img-11.jpg";
    ...
    <div className="trip">
      ...
      <div className="tripcard">
        ...
        <TripData
          ...
          text="France, in Western Europa, encompasses medieval cities, alpine villages and Mediterranean beaches. Paris, its capital is famed for its fashion houses, classical art museums including the Louvre and monuments like the Eiffel Tower."
        />
      </div>
    </div>
  );
